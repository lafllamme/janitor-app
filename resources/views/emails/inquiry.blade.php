...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
	...
	max-width: 560px;" class="wrapper">
			...
			color: #F0F0F0;" class="preheader">
                            ...
                            <!-- LOGO -->
                            <a target="_blank" style="text-decoration: none;" href="http://localhost/#contact"><img border="0" vspace="0" hspace="0" src="https://i.imgur.com/VVoeQVw.png" width="75" height="75" alt="Logo" title="Logo" style="
				color: #000000;
	...
	max-width: 560px;" class="container">
			...
			font-family: sans-serif;" class="subheader">
                            Für den Service von&nbsp;{{$validated['service']}}&nbsp;
                        </td>
                    </tr>
			...
			padding-top: 20px;" class="hero"><a target="_blank" style="text-decoration: none;" href="http://localhost/#contact"><img border="0" vspace="0" hspace="0" src="https://i.pinimg.com/originals/f5/fb/5e/f5fb5efe6b9f1d5f11f19e69f67f5ccf.gif" alt="Please enable images to view this content" title="Hero Image" width="560" style="
			width: 100%;
			max-width: 560px;
			...
			font-family: sans-serif;" class="paragraph">
                    ...
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			padding-top: 25px;
			padding-bottom: 5px;" class="button"><a href="{{'mailto:'.$validated['email']}}" target="_blank" style="text-decoration: underline;">
					...
					color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;" href="{{'mailto:'.$validated['email']}}">
                                                Antworten
                                            </a>
                                        </td>
                                    </tr>
			...
			padding-top: 25px;" class="line">
					...
					color: #000000;" src="https://i.imgur.com/0PxugC0.png" alt="D" title="Designer friendly" width="50" height="50"></td>
					...
					color: #000000;
					font-family: sans-serif;" class="paragraph">
                                        <b style="color: #333333;">Datum</b><br />
                                        Empfangen am {{ \Carbon\Carbon::now()}}
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
                            Absender? <a href="{{'mailto:'.$validated['email']}}" target="_blank" style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">{{$validated['email']}}</a>
                        </td>
                    </tr>
	...
	max-width: 560px;" class="wrapper">
			...
			font-family: sans-serif;" class="footer">
                            ...
                            Diese Email wurde automatisch&nbsp;generiert und benötigt keiner weiteren Antwort. &nbsp;Drücken Sie auf&nbsp;den Button,&nbsp;um direkt zu antworten.&nbsp;Drücken Sie für&nbsp;<a href="https://github.com/konsav/email-templates/" target="_blank" style="text-decoration: underline; color: #999999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;">weitere Infos</a> hier.
